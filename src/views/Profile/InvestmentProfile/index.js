        ...
        <React.Fragment>
            ...
            <Row justify='center' gutter={[0,20]}>
                <Col xs={{ span: 23, offset: 0 }} lg={{ span: 16, offset: 0 }}>
                    <PageHeading>Investment Profile</PageHeading>
                    <Divider/>
                </Col>
            </Row>
            <Row justify='center' gutter={[0,30]}>
                ...
                <Col xs={{ span: 23, offset: 0 }} lg={{ span: 9 , offset: 0, pull:1 }}>
            ...
            <Row justify='center' gutter={[0,30]}>
                ...
                <Col xs={{ span: 23, offset: 0 }} lg={{ span: 5 }}>
            ...
            <Row justify='center' gutter={[0,30]}>
                <Col xs={{ span: 23, offset: 0 }} lg={{ span: 15 }}>
